...
Notre stage a été effectué au sein de la société Mobelite, située à Monastir. Il s’agit d’une filiale offshore de la société Mobelite France. Elle est spécialisée dans le conseil en stratégie mobile, la conception et le développement d’applications mobiles et de sites web, ainsi que dans le marketing mobile. Elle dispose d’équipes commerciales et marketing à Paris (France), et d’équipes de développement à Monastir (Tunisie).
Mobelite possède 12 ans d’expérience et compte une centaine de collaborateurs. Elle a plus de 90 clients, principalement en France, et a réalisé plus de 150 projets. La figure~\ref{fig:my_label} présente le logo de Mobelite.
...
\subsection{Solutions existantes pour l'analyse des signaux vitaux}
...
\hline
VitalSigns Philips  & Hospitalier & Très élevé & Très élevée & FC, FR, SpO2 , PA, Temperature \\
\hline
\textbf{MindCare-AI} & \textbf{Intégré} & \textbf{Gratuit} & \textbf{Élevée} & \textbf{FC, PA, état émotionnel}  \\
\hline
\end{tabular}
...
\hline
\textbf{Solution}  & \textbf{Coût} & \textbf{Personnalisation} & \textbf{Intégration} \\
\hline
...
\begin{itemize}
    ...
    \item \textbf{Validation scientifique} : Peu de solutions combinent approches conversationnelles naturelles et fondements thérapeutiques rigoureux
\end{itemize}
...
\begin{enumerate}
    \item \textbf{Analyse physiologique non invasive par caméra} \\ 
    ...
    Le système intègre des modèles d’intelligence artificielle capables d’analyser le langage naturel (messages textuels) de l’utilisateur afin de détecter ses émotions dominantes (joie, tristesse, colère, peur, amour, surprise). Cette analyse permet de mieux comprendre l’état psychologique du patient et d’identifier rapidement les situations à risque ou les changements d’humeur.
    \item \textbf{Chatbot thérapeutique interactif} \\ 
    MindCare-AI propose un agent conversationnel intelligent, accessible 24/7, qui dialogue avec l’utilisateur, pose des questions d’auto-évaluation validées cliniquement, évalue le niveau de stress, et fournit des conseils personnalisés. Le chatbot peut également proposer des exercices de relaxation, des recommandations de musicothérapie ou orienter l’utilisateur vers un professionnel en cas de besoin.
...
\subsection{Méthodologie Agile avec Scrum pour le développement de l'application mobile}
...
\subsection{Méthodologie pour la Data Science}
...
\begin{figure}[h]
    ...
    \caption{Étapes de la méthodologie CRISP-DM appliquées à MindCare-AI}
\end{figure}

\section{Planification du projet}

La planification du projet MindCare-AI s’est déroulée selon plusieurs phases principales, chacune correspondant à des objectifs précis et à des livrables identifiés. Voici les étapes majeures du projet :

\begin{itemize}
    \item \textbf{Tâche 1 :} Analyse des objectifs du projet, étude des solutions existantes et identification des besoins spécifiques.
    \item \textbf{Tâche 2 :} Création des maquettes et prototypes des interfaces utilisateur (UI).
    \item \textbf{Tâche 3 :} Élaboration de l’architecture du système, choix des technologies, modélisation des données et définition des interfaces.
    \item \textbf{Tâche 4 :} Préparation des données, entraînement et évaluation des modèles pour l’analyse des signes vitaux.
    \item \textbf{Tâche 5 :} Conception des scénarios de dialogue, intégration du NLP et des modèles de recommandation pour le chatbot.
    \item \textbf{Tâche 6 :} Développement de l’interface utilisateur (Frontend) et du backend (fonctionnalités de base).
    \item \textbf{Tâche 7 :} Intégration du frontend avec le backend.
    \item \textbf{Tâche 8 :} Déploiement des modèles dans l’application mobile.
    \item \textbf{Tâche 9 :} Rédaction du rapport.
\end{itemize}
...
\begin{figure}[H]
    ...
    \begin{ganttchart}[
        ...
        title label font=\itshape\large,
        bar label font=\itshape
    ]{1}{5}
        \gantttitle{Février}{1}
        \gantttitle{Mars}{1}
        \gantttitle{Avril}{1}
        \gantttitle{Mai}{1}
        \gantttitle{Juin}{1} \\
        \ganttbar[bar/.append style={fill=blue!60}]{Tâche1}{1}{1} \\
        \ganttbar[bar/.append style={fill=orange!70}]{Tâche2}{1}{2} \\
        \ganttbar[bar/.append style={fill=teal!60}]{Tâche3}{2}{2} \\
        \ganttbar[bar/.append style={fill=red!60}]{Tâche4}{3}{3} \\
        \ganttbar[bar/.append style={fill=purple!60}]{Tâche5}{3}{4} \\
        \ganttbar[bar/.append style={fill=lime!60}]{Tâche6}{4}{4} \\
        \ganttbar[bar/.append style={fill=cyan!60}]{Tâche7}{3}{5} \\
        \ganttbar[bar/.append style={fill=yellow!80!black}]{Tâche8}{5}{5} \\
        \ganttbar[bar/.append style={fill=magenta!60}]{Tâche9}{5}{5} \\
    \end{ganttchart}
