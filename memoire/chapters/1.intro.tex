...
La réussite d’un projet repose en grande partie sur la méthodologie choisie pour sa conduite. Une approche méthodologique rigoureuse favorise une progression structurée, une meilleure gestion des imprévus et l’assurance de livrables de qualité. Dans le contexte de ce projet, qui associe la mise en œuvre de modèles d’intelligence artificielle et le développement mobile, il est primordial d’adopter des méthodologies adaptées à chaque domaine. Ainsi, deux approches complémentaires ont été retenues : la méthodologie CRISP-DM pour les étapes relevant de la Data Science, et l’approche Agile pour le développement logiciel.
