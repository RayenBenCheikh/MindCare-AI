...
export const API_URLS = {
  ...
  ios: "http://192.168.1.4:5000", // iOS simulator uses localhost directly
  // Add production URL when ready
  production: "https://api.mindcare-ai.com",
};
// Add specific URLs for the vital signs analyzer
export const VITAL_SIGNS_URLS = {
  local: "http://192.168.1.4:5001", // Flask server on port 5001
